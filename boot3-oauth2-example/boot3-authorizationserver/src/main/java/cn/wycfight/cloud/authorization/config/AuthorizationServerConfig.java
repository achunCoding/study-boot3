 ...
 */
package cn.wycfight.cloud.authorization.config;

import cn.wycfight.cloud.authorization.authentication.DeviceClientAuthenticationProvider;
import cn.wycfight.cloud.authorization.federation.FederatedIdentityIdTokenCustomizer;
import cn.wycfight.cloud.authorization.jose.Jwks;
import cn.wycfight.cloud.authorization.web.authentication.DeviceClientAuthenticationConverter;
...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
				...
				.redirectUri("http://127.0.0.1:10400/login/oauth2/code/messaging-client-oidc")
				.redirectUri("http://127.0.0.1:10400/authorized")
