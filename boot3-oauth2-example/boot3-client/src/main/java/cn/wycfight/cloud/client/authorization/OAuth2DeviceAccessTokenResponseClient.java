...
/**
 * 用于请求OAuth 2.0设备访问令牌并解析响应。使用RestOperations实现HTTP通信，并支持基本身份验证。
 */
public class OAuth2DeviceAccessTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2DeviceGrantRequest> {
